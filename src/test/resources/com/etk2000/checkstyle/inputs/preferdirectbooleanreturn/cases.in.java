...
class InputPreferDirectBooleanReturnAtomicDollarSignSliceViolation {
	boolean m(boolean foo$bar) {
		if (foo$bar) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnAtomicMethodCallNegatedSliceViolation {
	boolean m(String s) {
		if (s.isEmpty()) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnAtomicSupplementaryCodepointSliceViolation {
	boolean m(boolean 𝐀) {
		if (𝐀) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnBlankLineBetweenBodyAndTrailingSkippedSliceViolation {
	boolean m(boolean flag) {
		if (flag) return true; // violation: Redundant if returning a boolean literal, return the condition directly.
...
class InputPreferDirectBooleanReturnBlockCommentWithStarMidBodySliceViolation {
	boolean m(boolean flag) {
		if (/* a * b ) */ flag) return true; // violation: Redundant if returning a boolean literal, return the condition directly.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnCharLiteralEscapeSliceViolation {
	boolean m(char c) {
		if (c == '\'') return true; // violation: Redundant if returning a boolean literal, return the condition directly.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnCombineAndSliceViolation {
	boolean m(boolean a, String s) {
		if (a) return s.isEmpty(); // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnCombineAndAssignWrapsSliceViolation {
	boolean m(boolean x, String s) {
		if (x = s.isEmpty()) // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
			return s.isBlank();
		return false;
	}
}
...
class InputPreferDirectBooleanReturnCombineAndCommentSliceViolation {
	boolean m(boolean a, boolean b, String s) {
		if (a // note // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
				&& b) return s.isEmpty();
		return false;
	}
}
...
class InputPreferDirectBooleanReturnCombineAndMultilineCondSliceViolation {
	boolean m(boolean a, boolean b, String s) {
		if (a // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
				&& b)
			return s.isEmpty();
		return false;
	}
...
class InputPreferDirectBooleanReturnCombineAndTernaryWrapsSliceViolation {
	boolean m(boolean a, boolean b, boolean c, boolean d) {
		if (a) return b ? c : d; // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnCommentBetweenBracesSkippedSliceViolation {
	boolean m(boolean flag) {
		if (flag) // comment // violation: Redundant if returning a boolean literal, return the condition directly.
			return true;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnComparisonNegatedAddsParensSliceViolation {
	boolean m(int x) {
		if (x > 0) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnCondInQuotesIgnoredSliceViolation {
	boolean m(String s) {
		if (s.equals(")")) return true; // violation: Redundant if returning a boolean literal, return the condition directly.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnCondWithStringLiteralIsNotAtomicSliceViolation {
	boolean m(String s) {
		if ("x".equals(s)) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnDoubleNegationSimplifiesSliceViolation {
	boolean m(boolean flag) {
		if (!flag) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnLandConditionNegatedAddsParensSliceViolation {
	boolean m(boolean a, boolean b) {
		if (a && b) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnLandConditionNotNegatedNoParensSliceViolation {
	boolean m(boolean a, boolean b) {
		if (a && b) return true; // violation: Redundant if returning a boolean literal, return the condition directly.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnMixed3cBasicSliceViolation {
	boolean m(boolean flag, String s) {
		if (flag) return true; // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
		return s.isEmpty();
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnMixed3cElseFormSliceViolation {
	boolean m(boolean flag, String s) {
		if (flag) { // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
			return true;
		}
		else {
			return s.isEmpty();
...
class InputPreferDirectBooleanReturnMixed3cTernaryWrapsSliceViolation {
	boolean m(boolean a, boolean b, boolean c, boolean d) {
		if (a) return true; // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
		return b ? c : d;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnMixed3dBasicSliceViolation {
	boolean m(boolean flag, String s) {
		if (flag) return false; // violation: Redundant if returning a boolean literal, combine into a single short-circuit return.
		return s.isEmpty();
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnMultilineCondAtomicForwardSliceViolation {
	boolean m(String s) {
		if (s // violation: Redundant if returning a boolean literal, return the condition directly.
				.isEmpty()) return true;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnMultilineCondBlockCommentInlineSliceViolation {
	boolean m(boolean a, boolean b) {
		if (a /* note */ // violation: Redundant if returning a boolean literal, return the condition directly.
				&& b) return true;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnMultilineCondBlockCommentSpansSliceViolation {
	boolean m(boolean a, boolean b) {
		if (a // violation: Redundant if returning a boolean literal, return the condition directly.
				/* spanning
				block */ && b) return true;
		return false;
	}
...
class InputPreferDirectBooleanReturnMultilineCondCharParenSliceViolation {
	boolean m(char c, boolean flag) {
		if (c == ')' // violation: Redundant if returning a boolean literal, return the condition directly.
				&& flag) return true;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnMultilineCondMultiCommentsSliceViolation {
	boolean m(boolean a, boolean b, boolean c) {
		if (a // c1 // violation: Redundant if returning a boolean literal, return the condition directly.
				&& b // c2
				&& c) return true;
		return false;
	}
...
class InputPreferDirectBooleanReturnMultilineCondPatternInstanceofSliceViolation {
	boolean m(Object obj) {
		if (obj instanceof String s // violation: Redundant if returning a boolean literal, return the condition directly.
...
class InputPreferDirectBooleanReturnMultilineCondStringParenSliceViolation {
	boolean m(String s, boolean flag) {
		if (s.equals("a)b") // violation: Redundant if returning a boolean literal, return the condition directly.
				&& flag) return true;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnMultilineCondStringSlashesSliceViolation {
	boolean m(String s, boolean flag) {
		if (s.equals("//x") // violation: Redundant if returning a boolean literal, return the condition directly.
				&& flag) return true;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnNestedParensInConditionSliceViolation {
	boolean m(boolean a, boolean b, boolean c) {
		if ((a || b) && c) return true; // violation: Redundant if returning a boolean literal, return the condition directly.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnNestedParensInConditionNegatedSliceViolation {
	boolean m(boolean a, boolean b, boolean c) {
		if ((a || b) && c) return false; // violation: Redundant if returning a boolean literal, return the condition directly.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnSameLiteralBothSliceViolation {
	boolean m(boolean flag) {
		if (flag) return true; // violation: Both branches return the same literal, remove the redundant if.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnSameLiteralChainedComparisonSkippedSliceViolation {
	boolean m(int index, int size, String s) {
		if (index < size == s.isEmpty()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralDropArrayIndexSliceViolation {
	boolean m(boolean[] flags, int i) {
		if (flags[i]) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralDropCastSliceViolation {
	boolean m(Object obj) {
		if ((boolean) obj) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralDropDivisionSliceViolation {
	boolean m(int a, int b) {
		if (a / b > 0) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralElseFormSliceViolation {
	boolean m(boolean flag) {
		if (flag) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		else
			return true;
	}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAndBothSliceViolation {
	boolean m(String s) {
		if (s.isEmpty() && s.isBlank()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAndInstanceofSliceViolation {
	...
	boolean m() {
		if (box() instanceof String && sideEffect()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAndLeftSliceViolation {
	boolean m(boolean a, String s) {
		if (s.isEmpty() && a) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAndParenRightSliceViolation {
	boolean m(boolean flag, String s) {
		if (s.isEmpty() && (flag = s.isBlank())) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAssignSliceViolation {
	boolean m(boolean flag, boolean other) {
		if (flag = other) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAssignComparisonSliceViolation {
	boolean m(boolean found, int a, int b) {
		if (found = a > b) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAssignParenComparisonSliceViolation {
	boolean m(int len, String s) {
		if ((len = s.length()) > 0) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractAssignPostfixRhsSliceViolation {
	boolean m(int i, int x) {
		if ((x = i++) > 0) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractBsrAssignSliceViolation {
	boolean m(int x) {
		if ((x >>>= 1) > 0) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractCastCallSliceViolation {
	...
	boolean m() {
		if ((boolean) box()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractCastInstanceofPrefixSliceViolation {
	...
	boolean m() {
		if ((boolean) instanceofCheck()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractCastNestedSliceViolation {
	...
	boolean m() {
		if ((boolean) (Boolean) box()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractDivAssignSliceViolation {
	boolean m(int x) {
		if ((x /= 2) > 0) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractGeSliceViolation {
	boolean m(String s) {
		if (s.length() >= 2) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractGenericCallSliceViolation {
	boolean m() {
		if (new HashSet<String>().add("x")) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractLeSliceViolation {
	boolean m(String s) {
		if (s.length() <= 5) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractMethodCallSliceViolation {
	boolean m(String s) {
		if (s.isEmpty()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractNeSliceViolation {
	boolean m(String s) {
		if (s.length() != 3) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractParenWholeComparisonSliceViolation {
	boolean m(int size, String s) {
		if ((size <= s.length())) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractParenWholeShortcircuitSliceViolation {
	boolean m(boolean a, String s) {
		if ((a && s.isEmpty())) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractPostfixDecSliceViolation {
	boolean m(int i) {
		if (i-- > 0) // violation: Both branches return the same literal, remove the redundant if.
			return false;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractPostfixIndexSliceViolation {
	boolean m(int[] arr, int i) {
		if (arr[i]++ > 0) // violation: Both branches return the same literal, remove the redundant if.
			return false;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractPrefixIncReversedSliceViolation {
	boolean m(int i) {
		if (0 < ++i) // violation: Both branches return the same literal, remove the redundant if.
			return false;
		return false;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractShiftSliceViolation {
	boolean m(int a, int b, String s) {
		if (a >> b == s.length()) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralExtractShiftRightAssignSliceViolation {
	boolean m(int n) {
		if ((n >>= 1) > 0) // violation: Both branches return the same literal, remove the redundant if.
			return true;
		return true;
	}
}
...
class InputPreferDirectBooleanReturnSameLiteralFalseSliceViolation {
	boolean m(boolean flag) {
		if (flag) return false; // violation: Both branches return the same literal, remove the redundant if.
		return false;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnSameLiteralLandCondSliceViolation {
	boolean m(boolean a, boolean b) {
		if (a && b) return true; // violation: Both branches return the same literal, remove the redundant if.
		return true;
	}
}
// === end ===
...
class InputPreferDirectBooleanReturnSameLiteralMultilineCondSliceViolation {
	boolean m(boolean a, boolean b) {
		if (a // violation: Both branches return the same literal, remove the redundant if.
				&& b)
			return true;
		return true;
	}
