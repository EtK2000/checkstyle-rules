...
class InputPreferMathMethodClean {
	...
	int ifCompoundAssignDifferentOps(int r, int a, int b) {
		if (a > b)
			r += a;
		else
			r -= b;
	...
	int ifEmptyTrueBlock(int a, int b) {
		if (a > b) {}
		else {
			return a;
		}
	...
	int ifInitOverwriteDeclNameMismatch(int r, int a, int b) {
		var s = a;
		if (a > b)
			r = a;
		return r + s;
	...
	int ifInitOverwriteNonDeclAbove(int r, int a, int b) {
	...
	int ifInitOverwriteOperandMismatch(int a, int b, int c, int d) {
		var r = c;
		if (a > b)
			r = d;
		return r;
	...
	int ifNoElseCompoundAssign(int r, int a, int b) {
		if (a > b)
			r += a;
		return r;
	}

	int ifNoElsePlainAssignNoDecl(int r, int a, int b) {
		if (a > b)
			r = a;
		return r;
	}
	...
	int ifReturnElseOperandMismatch(int a, int b, int c) {
		if (a > b)
			return a;
		else
			return c;
	...
	int ifReturnThenElseAssign(int r, int a, int b) {
		if (a > b)
			return a;
		else
			r = b;
	...
	int ifTrailingReturnOperandMismatch(int a, int b, int c) {
		if (a > b)
			return a;
		return c;
	}
	...
	int wrongAbsBranchAGtZero(int a) {
		return a > 0 ? -a : a;
	}

	int wrongAbsBranchZeroGtA(int a) {
		return 0 > a ? a : -a;
	}

	int wrongAbsBranchZeroLeA(int a) {
		return 0 <= a ? -a : a;
	}

	int wrongAbsBranchZeroLtA(int a) {
		return 0 < a ? -a : a;
	}
