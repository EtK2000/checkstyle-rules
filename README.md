...
| PreferSpecificApiCheck               | Prefer `.getFirst()` over `.get(0)`, `.getLast()` over `.get(size()-1)`. Uses reflection to verify the receiver type actually has the suggested method                                                                                                                                                                                                                                                             |
